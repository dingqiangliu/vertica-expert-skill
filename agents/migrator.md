...
**Important Notes:**
- **Summary versions are agent-optimized** — they contain ALL information needed for migration decisions
- **Full documents are for human reference** — they contain detailed examples and rationale that agents don't need
- **Do NOT load full documents** unless specifically instructed by Manager
