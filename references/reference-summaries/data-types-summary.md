...
This summary contains ALL information needed for data type conversion decisions. The full document is for human reference with detailed examples.

**For complete examples and rationale, see [data-types.md](../data-types.md).**
