...
This summary contains ALL information needed for migration decisions. The full document is for human reference with detailed examples.

**For complete examples and rationale, see [generic-migration-guide.md](../generic-migration-guide.md).**
