...
Load [oracle-migration.md](../oracle-migration.md) section by section when:
...
How to load: `grep -n "^## \|^### " references/oracle-migration.md` → `Read offset=N limit=M` (load ONLY that section, NOT the entire file).
