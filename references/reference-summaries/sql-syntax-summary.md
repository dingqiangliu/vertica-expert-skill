...
Load [sql-syntax-reference.md](../sql-syntax-reference.md) section by section when:
...
How to load: `grep -n "^## \|^### " references/sql-syntax-reference.md` → `Read offset=N limit=M` (load ONLY that section, NOT the entire file).
